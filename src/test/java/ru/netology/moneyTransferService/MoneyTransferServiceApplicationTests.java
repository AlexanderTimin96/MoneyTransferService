...
//        ResponseEntity<ResponseOperation> responseFromTransfer = restTemplate.postForEntity("http://localhost:"
//                        + moneyTransferService.getMappedPort(5500) + "/transfer",
//                data.getCorrectRequestForMoneyTransfer(), ResponseOperation.class);
//        ResponseOperation expected = data.getResponseTransfer();
//        Assertions.assertEquals(expected, responseFromTransfer.getBody());
//    }
//
//    @Test
//    public void moneyTransferService_confirmOperation_Test() {
//        ResponseEntity<ResponseOperation> responseFromConfirmOperation = restTemplate.postForEntity("http://localhost:"
//                        + moneyTransferService.getMappedPort(5500) + "/confirmOperation",
//                data.getRequestForConfirmOperation(), ResponseOperation.class);
//        ResponseOperation expected = data.getResponseTransfer();
